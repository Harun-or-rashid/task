...
Auth::routes();
    Route::group(['prefix' => 'admin', 'middleware' => ['web']], function() {
        ...
        Route::middleware(['auth:admin', 'checkRolePermissions'])->group(function() {
            // Logout
            Route::get('/logout-admin', [AuthController::class, 'logout'])->name('logout.submit');
            ...
            Route::get('/employee-report/{id}', [ReportController::class, 'generatePDF'])->name('employee.report.pdf.download');
            Route::get('/teams/average-salary/pdf/{id}', [ReportController::class, 'teamSalaryReportpdf'])->name('teams.average.salary.pdf.download');
        });
    });
